...
ROUTES=(
  ...
  "senso-trick:/dev/senso-preview?scene=trick"
  "senso-trick-5p:/dev/senso-preview?scene=trick-5p"
  "senso-trick-2p:/dev/senso-preview?scene=trick-2p"
  "senso-settle:/dev/senso-preview?scene=settle"
  "senso-trick-lead-ninja:/dev/senso-preview?scene=trick-lead-ninja"
  "senso-trick-phone411:/dev/senso-preview?scene=trick&frame=411x915"
  "senso-trick-5p-phone360:/dev/senso-preview?scene=trick-5p&frame=360x644"
  "senso-cards:/dev/senso-cards"
  "senso-cards-ladder:/dev/senso-cards?scene=ladder"
  "senso-cards-fan-phone411:/dev/senso-cards?scene=fan&frame=411x915"
  "arrival-preview:/dev/arrival-preview?scene=three"
  "arrival-preview-one:/dev/arrival-preview?scene=one"
  "arrival-preview-phone411:/dev/arrival-preview?scene=three&frame=411x915"
  "arrival-preview-phone360:/dev/arrival-preview?scene=two&frame=360x644"
  "dashboard:/"
  "history:/history"
  "games:/games"
)
...
NAV_EXEMPT=(
  ...
  "senso-trick-2p"
  "senso-settle"
  "senso-trick-lead-ninja"
  "senso-trick-phone411"
  "senso-trick-5p-phone360"
  "senso-cards"
  "senso-cards-ladder"
  "senso-cards-fan-phone411"
  "arrival-preview"
  "arrival-preview-one"
  "arrival-preview-phone411"
  "arrival-preview-phone360"
  "theme-preview"
)
