...
function ShapeSVG({
  ...
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 40 60"
      className="w-[4.5rem] shrink-0 aspect-[2/3] overflow-visible"
    >
      {fill === "striped" && (
        <defs>
...
export default function SetCard({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={[
        "h-full w-full flex flex-row items-center justify-center gap-3 rounded-xl border-2 bg-white px-3 py-3 shadow transition-all duration-300",
        borderClass,
