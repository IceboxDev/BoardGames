...
const VARIANTS: Record<Variant, string> = {
  ...
  subtle: "text-gray-400 hover:bg-surface-800 hover:text-gray-100",
  ...
  bordered:
    "border border-white/15 text-gray-400 hover:border-white/30 hover:bg-white/5 hover:text-white",
};
...
const PRESSED: Record<Variant, string> = {
  ...
  subtle: "bg-surface-700 text-gray-100",
