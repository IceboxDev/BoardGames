...
export default function ScoreBoard({
  ...
  return (
    <div className="rounded-lg border border-white/10 bg-surface-900/70 p-3">
      <h3 className="mb-2 text-xs font-semibold uppercase tracking-wider text-fg-secondary">
        Scores
      </h3>
      <table className="w-full text-xs">
        ...
        <tbody>
          {Array.from({ length: playerCount }, (_, i) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: static score table
            <tr key={i} className={i === myIndex ? "text-orange-300" : "text-fg-secondary"}>
