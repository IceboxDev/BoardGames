...
export default function Table({ table, trumpSuit, isDefending, onClickUndefended }: TableProps) {
  if (table.length === 0) {
    return (
      <div className="flex min-h-[8rem] items-center justify-center rounded-xl border border-dashed border-line text-sm text-fg-muted">
