...
const PURCHASES: Purchase[] = [
  {
    ...base,
    id: "frosthaven",
    title: "Frosthaven (2nd printing) — Wave 1",
    shortTitle: "Frosthaven",
    orderGroup: { id: "frosthaven-pledge", title: "Frosthaven All-In" },
    kind: "crowdfunding",
    status: "shipping",
  ...
  },
  {
    ...base,
    id: "frosthaven-solo",
    title: "Frosthaven Solo Scenarios — Wave 2",
    shortTitle: "Solo Scenarios",
    orderGroup: { id: "frosthaven-pledge", title: "Frosthaven All-In" },
    kind: "crowdfunding",
    status: "production",
    platform: "Kickstarter",
    campaignUrl: "https://www.kickstarter.com/projects/frosthaven",
    pledgeManagerUrl: "https://gamefound.com/orders/frosthaven",
    originalEtaMonth: "2026-08",
    currentEtaMonth: "2027-01",
    pledgedOn: "2025-04-12",
    pledgeCents: 2500,
    events: [
      {
        id: "frosthaven-solo-e01",
        occurredOn: "2026-07-02",
        type: "delay",
        title: "Solo book reprint pushes wave 2 to January",
        details: "Print errors found in the proof; wave 2 waits for the corrected run.",
        sourceUrl: null,
      },
    ],
  },
